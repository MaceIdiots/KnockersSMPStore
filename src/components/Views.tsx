      ...
      >
        ...
        <div className="space-y-4 relative z-10">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Secure synchronization & instant sandbox. Access your coins and team roster in real-time.
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            {onLoginAsGuest && (
              <button 
                ...
                disabled={loading}
                className="w-full py-5 bg-green-600 hover:bg-green-500 text-white font-bold text-xl pixel-corners transition-all flex items-center justify-center gap-3 shadow-[0_8px_0_0_#15803d] active:shadow-none active:translate-y-2 group"
              >
                <div className="w-6 h-6 bg-green-800 rounded-full flex items-center justify-center text-[10px] text-white">★</div>
                PLAY AS GUEST (FAST CONNECT)
              </button>
            )}
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="flex justify-center items-center gap-4 text-[10px]">
                ...
                <span className="text-gray-500 font-medium">Use New Tab or Guest mode inside sandbox preview-frame</span>
              </div>
            </div>
          </div>
